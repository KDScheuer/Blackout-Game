...
class Overlay:
    def __init__(self, screen, shots, level, level_details, angle, power):
        ...
        self.level = level
        self.level_surface = self.level_font.render(self.level, True, 'yellow')

        self.star_font = pygame.font.Font(None, 35)
        self.star_text = '3 Stars: ' + (str(level_details['Stars']['3 Star']) + '     ' + '2 Stars: ' +
                                        str(level_details['Stars']['2 Star']) + '     ' + ' 1 Star: ' +
                                        str(level_details['Stars']['1 Star']) + '+')
        self.star_text_surface = self.star_font.render(self.star_text, True, 'yellow')
    ...
    def update(self):
        ...
        self.screen.blit(self.star_text_surface, (800, 10))
